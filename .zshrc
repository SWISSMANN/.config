...
## Start Typewriter Prompt ##
fpath+=$HOME/.oh-my-zsh/templates/typewritten
autoload -U promptinit; promptinit
prompt typewritten

## Alias Shorting Commands ##
...
alias vi=nvim
alias vim=nvim
alias ttyc="tty-clock -s -c -f %d/%m/%Y"
alias neofetch="neofetch --off"
alias cav=cava
alias sccc="sudo cp config.def.h config.h"
alias smci="sudo make clean install"


## Path to my Scripts Direcotry ##
